...
class FourierPositionalEncoding(nn.Module):
    ...
    def __init__(self, embedding_dim, max_length=120):
        super().__init__()
...
class FourierSummaryEmbedding(nn.Module):
    ...
    def __init__(self, embedding_dim, max_levels, max_length=120):
        super().__init__()
        self.embedding_dim = embedding_dim
        self.max_levels = max_levels
...
class Transformer_Model(nn.Module):
    ...
    def __init__(self, vocab_size, embedding_dim, num_layers, num_heads, seq_length, hierarchy_levels=3, chunk_size=30):
        super().__init__()
        self.embed_size = embedding_dim
        self.hierarchy_levels = hierarchy_levels
        self.chunk_size = chunk_size
