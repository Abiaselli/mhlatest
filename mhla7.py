...
class ReasoningModelGUI:
    ...
    def training_loop(self):
        ...
        try:
            ...
            adamw_params = [
                p for name, p in self.model.named_parameters()
                if p.ndim < 2 or "rule_scores" in name or "bias" in name or (
                    "embedding" in name and "rule_transform" not in name
                )
            ]
                        ...
                        if self.use_genetic_algo == "Genetic Algorithm":
                            ...
                            if (batch_idx + 1) % accumulation_steps == 0:     
                                    ...
                                    if architecture == "Rule Transformer":
                                        ...
                                        self.model.embedding.validate_and_replace_rule(self.model, val_input, val_target, val_input, loss_fn)
